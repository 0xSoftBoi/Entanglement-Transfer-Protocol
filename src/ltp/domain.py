...
__all__ = [
    ...
    "DOMAIN_PROVENANCE_ORIGINATOR",
    "DOMAIN_WITNESS_COSIGN",
    # Legacy tags
    "LEGACY_COMMIT_V1",
    "LEGACY_RECORD_V1",
    # Functions
...
DOMAIN_PROVENANCE_ORIGINATOR = b"GSX-LTP:provenance-originator:v1\x00"
DOMAIN_WITNESS_COSIGN = b"GSX-LTP:witness-cosign:v1\x00"
...
_ALL_TAGS: dict[str, bytes] = {
    ...
    "DOMAIN_PROVENANCE_ORIGINATOR": DOMAIN_PROVENANCE_ORIGINATOR,
    "DOMAIN_WITNESS_COSIGN": DOMAIN_WITNESS_COSIGN,
